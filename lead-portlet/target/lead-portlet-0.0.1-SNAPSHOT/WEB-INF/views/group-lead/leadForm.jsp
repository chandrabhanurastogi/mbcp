...
<portlet:actionURL var="groupLeadGenerationURL">
...
<div>
	<form:form class="form-register" method="post"
		commandName="leadModelBean" action="${groupLeadGenerationURL}">
		<c:if test="${leadModelBean.success == true}">

			<div class="success_message">
				<div style="margin: 12px 0 0px 18px;">Group Lead Created
					Successfully</div>
			</div>
		</c:if>
		...
		<table width="100%" class="registertable">
			<tbody>
				...
				<tr>
					<td class="td1"><label for="paddedLeadId">Ref. Id</label></td>
				...
				<tr>
					...
					<tr>
					<form:hidden path="proposalsMade[0].insuranceProduct.id" />
